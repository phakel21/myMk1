...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a href="" class="navbar-brand">Update Location</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto">
                <div class="navbar-nav">
                    <a href="/admin/control/locations" class="nav-item nav-link">Back</a>
                </div>
...
<div class="col">
    ...
    <div class="my-margin">
        <form:form class="row" method="post"
                   action="/admin/control/location/${location.name}/update/name">
    ...
    <div class="my-margin">
        ...
        <form:form class="row" method="post"
                   action="/admin/control/location/${location.name}/update/image"
