...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="navbar-nav">
                <a href="/lobby" class="nav-item nav-link ">Lobby</a>
            </div>
...
<div style="height: 650px">
    ...
    <div style="position: absolute;">
        <img class="char_div" style="z-index: 2; position: relative; top: 50px;"
             src="/images/characters/${hero.myCharacter.image}">
    </div>

    <div class="d-flex justify-content-end">
        <img class="char_div" style="z-index: 2; position: relative; top: 50px; transform: scaleX(-1)"
