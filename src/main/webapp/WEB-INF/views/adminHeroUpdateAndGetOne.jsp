...
<div class="col">
    ...
    <div class="my-margin">
        <form:form class="row" method="post"
                   action="/admin/control/hero/${hero.name}/update/name">
    ...
    <div class="my-margin">
        ...
        <form:form class="row" method="post"
                   action="/admin/control/hero/${hero.name}/update/character"
    ...
    <div class="my-margin">
        ...
        <form:form class="row" method="post"
                   action="/admin/control/hero/${hero.name}/update/user"
                   enctype="multipart/form-data">
            <div class="col d-flex justify-content-end">
...
<div class="container my-margin ">
    ...
    <table class="table table-dark ">
        ...
        <tr>
            ...
            <td><a href="/admin/control/myCharacter/${hero.myCharacterDTO.name}/edit">
