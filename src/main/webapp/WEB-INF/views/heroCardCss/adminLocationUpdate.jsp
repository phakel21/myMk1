        ...
        <div class="my-margin">
            <div class="row">
                <form:form class="row g-3 align-items-center" method="post"
                    ...
                    <div class="col">
                        <input name="updateName" type="text" id="name" class="form-control" style="width: 300px"/>
                    </div>
        ...
        <div class="my-mar">
            <div class="row">
                ...
                <form:form class="row g-3 align-items-center" method="post"
                    ...
                    <div class="col">
                        <input style="width: 300px;" type="file" name="updateImage" id="file" class="col-form-label "
                               accept="image/*"/>
